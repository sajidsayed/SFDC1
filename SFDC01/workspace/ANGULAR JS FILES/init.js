...
app.config(function ($routeProvider) {
    $routeProvider.
        when('/', {controller: HomeCtrl, templateUrl: 'apex/MobileSample_AngularHome1'}).
        ...
        when('/accounts', {controller: AccountListCtrl, templateUrl: 'apex/MobileSample_AngularList1'}).
        ...
        when('/viewaccountdetail/:accountId', {controller: AccountViewCtrl, templateUrl: 'apex/MobileSample_AngularView1'}).
